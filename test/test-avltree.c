...
{
    return jsw_avlnew ((cmp_f) strcmp, (dup_f) strdup, (rel_f) free);
}

void delete_container (void *c)
{
    jsw_avldelete ((jsw_avltree_t *) c);
}

bool insert_item (void *c, const char *item)
{
    return (0 != jsw_avlinsert ((jsw_avltree_t *) c, (void *) item));
}

bool remove_item (void *c, const char *item)
{
    return (0 != jsw_avlerase ((jsw_avltree_t *) c, (void *) item));
}

bool lookup_item (void *c, const char *item)
{
    return (NULL != jsw_avlfind ((jsw_avltree_t *) c, (void *) item));
}
