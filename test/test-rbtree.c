/*
  Test for jsw-lib red-black trees
...
{
    return jsw_rbnew ((cmp_f) strcmp, (dup_f) strdup, (rel_f) free);
}

void delete_container (void *c)
{
    jsw_rbdelete ((jsw_rbtree_t *) c);
}

bool insert_item (void *c, const char *item)
{
    return (0 != jsw_rbinsert ((jsw_rbtree_t *) c, (void *) item));
}

bool remove_item (void *c, const char *item)
{
    return (0 != jsw_rberase ((jsw_rbtree_t *) c, (void *) item));
}

bool lookup_item (void *c, const char *item)
{
    return (NULL != jsw_rbfind ((jsw_rbtree_t *) c, (void *) item));
}
